...
function PanelHeader({ title, subtitle, T }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 6, marginBottom: 6 }}>
      <h2 style={{ fontSize: 21, fontWeight: 900, color: T.txt, letterSpacing: "-0.4px", fontFamily: F, margin: 0, lineHeight: 1.1 }}>{title}</h2>
      {subtitle ? <p style={{ fontSize: 13, color: T.sub, fontWeight: 600, fontFamily: F, margin: 0, lineHeight: 1.1 }}>{subtitle}</p> : null}
    </div>
  );
}
